        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-md w-full max-w-[95vw] max-h-[90vh] min-h-[400px] h-auto p-0">
                <div className="flex items-center space-x-3 pt-10 -mb-4 px-4">
                    <Tabs defaultValue={tab} className="w-full">
                        <TabsList className="w-full">
                            <TabsTrigger value="chat" className="w-full" onClick={() => setTab('chat')}>Chat</TabsTrigger>
                            <TabsTrigger value="wellness" className="w-full" onClick={() => setTab('wellness')}>Wellness Check-In</TabsTrigger>
                        </TabsList>
                    </Tabs>
                </div>
                {tab === 'chat' && (
                ...
                {tab === 'wellness' && (
                    ...
                    // <div className="flex flex-col h-full border-0 max-h-[90vh]">
                    //     <elevenlabs-convai agent-id="agent_2201k25rgjbsfcy8aqk01pacs838"></elevenlabs-convai><script src="https://unpkg.com/@elevenlabs/convai-widget-embed" async type="text/javascript"></script>
                    // </div>
                )}
            </DialogContent>
        </Dialog>
